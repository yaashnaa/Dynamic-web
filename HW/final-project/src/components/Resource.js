  ...
  return (
    <div>
      ...
      <div className="articles">
        <div className="article" data-aos="flip-right"  data-aos-delay="300">
          <div className="heading-article">
            <a href="https://www.edamam.com/results/recipe/?recipe=chicken-and-sausage-with-blackberry-reduction-c64c7e537141d1fbb5e647c00382e09a/search=">
              Chicken and Sausage with Blackberry
            </a>
          </div>
        ...
        <div className="article" data-aos="flip-right"  data-aos-delay="600">
          <div className="heading-article">
            {" "}
            <a href="https://www.edamam.com/results/recipe/?recipe=herbed-beef-in-prosciutto-c217f6a518516320ccee30e89c2e789b/search=dinner">
              Herbed Beef in Prosciutto{" "}
            </a>{" "}
          </div>
          <div className="article-text">
        ...
        <div className="article" data-aos="flip-right"  data-aos-delay="900">
          <div className="heading-article">
            <a href="https://www.edamam.com/results/recipe/?recipe=fennel-and-orange-salad-80752914dec49cc3def054506be8bc12/search=salad">
